...
@Component({
  selector: 'app-sound-cat',
  templateUrl: './ltls-sound-test-cat.component.html',
  styleUrls: ['./ltls-sound-test-cat.component.scss'],
})
export class LtlsSoundTestCatComponent implements OnInit {
